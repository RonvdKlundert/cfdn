...
if fold == 0:
    mydat_train_stim = get_cortex(np.nan_to_num(np.load(f'/home/klundert/cfdn/data/CF_fit_utils/data_fold1_detrend_sub-0{sub}_psc_hcp.npy')))
    mydat_test_stim = get_cortex(np.nan_to_num(np.load(f'/home/klundert/cfdn/data/CF_fit_utils/data_fold2_detrend_sub-0{sub}_psc_hcp.npy')))
else:
    mydat_train_stim = get_cortex(np.nan_to_num(np.load(f'/home/klundert/cfdn/data/CF_fit_utils/data_fold2_detrend_sub-0{sub}_psc_hcp.npy')))
    mydat_test_stim = get_cortex(np.nan_to_num(np.load(f'/home/klundert/cfdn/data/CF_fit_utils/data_fold1_detrend_sub-0{sub}_psc_hcp.npy')))
...
np.save(f'/home/klundert/{folder}/CF_cortical_psc_fit_sub-{sub}_fold-{fold}_slice-{slice_n}.npy', gf_vis3.iterative_search_params)

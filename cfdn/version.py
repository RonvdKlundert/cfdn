...
License
=======
``cfdn`` is licensed under the terms of the MIT license. See the file
"LICENSE" for information on the history of this software, terms & conditions
for usage, and a DISCLAIMER OF ALL WARRANTIES.

All trademarks referenced herein are property of their respective holders.

Copyright (c) 2022--, RonvdKlundert,
...
DOWNLOAD_URL = "https://github.com/RonvdKlundert/cfdn/archive/refs/tags/v0.1.dev-alpha.tar.gz"
LICENSE = "MIT"
AUTHOR = "RonvdKlundert"
AUTHOR_EMAIL = "klundertclan@hotmail.com"
...
REQUIRES = ["numpy","matplotlib","scipy","nibabel","pandas","pyyaml","natsort","h5py"]

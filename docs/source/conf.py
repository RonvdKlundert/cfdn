...
# -*- coding: utf-8 -*-
#
# linescanning documentation build configuration file, created by
...
#     'github_repo': 'linescanning',
#     'github_button': 'true',
#     'description': 'package for (pre-)processing of anatomical and (linescanning) fMRI data',
#     'font_size': 9,
...
htmlhelp_basename = 'prfpy-cfdndoc'
...
latex_documents = [
    (master_doc, 'prfpy-cfdn.tex', 'prfpy-cfdn Documentation',
     'RonvdKlundert', 'manual'),
]
...
man_pages = [
    (master_doc, 'prfpy-cfdn', 'prfpy-cfdn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'prfpy-cfdn', 'prfpy-cfdn Documentation',
     author, 'prfpy-cfdn', 'Implementation and visualization of divisive normalization connective fields',
     'Miscellaneous'),
]
